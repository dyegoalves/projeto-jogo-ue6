...
function popup(url,params) {
  ...
  if(typeof params['location']=='undefined') params['location']='no';
  if(typeof params['menubar']=='undefined') params['menubar']='no';
  params['win']=window.open(url,params['win_name'],'scrollbars='+params['scroll']
   +',resizable='+params['resizable']+',toolbar=no,location='+params['location']
   +',directories=no,menubar='+params['menubar']+',status=yes,top=0,left='
